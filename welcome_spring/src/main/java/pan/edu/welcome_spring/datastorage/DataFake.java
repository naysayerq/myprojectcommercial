...
public class DataFake {
    ...
    private List<Rent> rents = new LinkedList<>(Arrays.asList(
            ...
            new Rent("345w", spaces.get(1), clients.get(1), LocalDateTime.now(), LocalDateTime.now()),
            new Rent("345e", spaces.get(2), clients.get(2), LocalDateTime.now(), LocalDateTime.now())
